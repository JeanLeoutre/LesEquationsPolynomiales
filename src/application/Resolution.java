...
public class Resolution {
	public ArrayList<String> premierDegre(double a, double b) {
		ArrayList<String> racine = new ArrayList<>();
		racine.add(Double.toString(-b/a));
		return racine;
	}
	
	public ArrayList<String> secondDegre(double a, double b, double c) {
	...
	public ArrayList<String> troisiemeDegre(int a, int b, int c, int d) {
		ArrayList<String> racines = new ArrayList<>();
		if (a == 0) {
